...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  vec3 col = vec3(0.0);
  vec3 defaultBase = vec3(0.0); // Background fallback
  ...
  if (enableBottom) {
    for (int i = 0; i < bottomLineCount; ++i) {
      ...
      vec3 lineCol = getLineColor(t, defaultBase);
...
export default function FloatingLines({
  // Updated default gradient: Start Cyan, Mid/End Dark Purple
  linesGradient = ['#52C1DE', '#371450', '#371450'], 
